...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "Celerium.FanartTV\docs"
        NO  - "Celerium.FanartTV\Celerium.FanartTV\docs"

    Example: "C:\Celerium\Projects\Celerium.FanartTV\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "Celerium.FanartTV\docs"
    Reference:
        Yes - "Celerium.FanartTV\docs\Endpoints.csv"
        NO  - "Celerium.FanartTV\Celerium.FanartTV\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\Celerium.FanartTV\docs\Endpoints.csv"

.PARAMETER githubPageUri
    Base url of the modules github pages

    Example: "https://celerium.github.io/Celerium.FanartTV"
...
.EXAMPLE
    .\Update-HelpContent.ps1
        ...
        -helpDocsPath "C:\Celerium\Projects\Celerium.FanartTV\docs"
        -csvFilePath "C:\Celerium\Projects\Celerium.FanartTV\docs\Endpoints.csv"
        -githubPageUri "https://celerium.github.io/Celerium.FanartTV"
...
$downloadLink = "$githubPageUri/docs/cab"
    ...
    $moduleDescription = 'This PowerShell module acts as a wrapper for the FanartTV API.'
