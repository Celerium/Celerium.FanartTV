...
.NOTES
    ...
    NAME: Celerium.FanartTV.Tests.ps1
    Type: PowerShell
...
.SYNOPSIS
    Pester tests for the Celerium.FanartTV module manifest file
...
.LINK
    ...
    https://github.com/Celerium/Celerium.FanartTV
...
Describe "Testing the [ $buildTarget ] version of [ $moduleName ] with [ $pester_TestName ]" {
    ...
    Context "[ $moduleName.psd1 ] general manifest data" {
        ...
        It "Manifest [ RootModule ] has valid data" {
            $Module.RootModule | Should -Be 'Celerium.FanartTV.psm1'
        }
        ...
        It "Manifest [ GUID ] has valid data" {
            $Module.GUID | Should -Be 'c12d6f12-8556-4172-a5d5-45d079b0c5f5'
        }
        ...
        It "Manifest [ Copyright ] has valid data" {
            $Module.Copyright | Should -Be 'https://github.com/Celerium/Celerium.FanartTV/blob/master/LICENSE'
        }
        ...
        It "Manifest [ NestedModules ] has valid data" {
            switch ($buildTarget) {
                ...
                'notBuilt'  { ($Module.NestedModules.Name).Count | Should -Be 17 }
            }
        }

        It "Manifest [ FunctionsToExport ] has valid data" {
            ($Module.ExportedCommands).Count | Should -Be 18
        }
        ...
        It "Manifest [ LicenseUri ] has valid data" {
            $Module.LicenseUri | Should -Be 'https://github.com/Celerium/Celerium.FanartTV/blob/master/LICENSE'
        }

        It "Manifest [ ProjectUri ] has valid data" {
            $Module.ProjectUri  | Should -Be 'https://github.com/Celerium/Celerium.FanartTV'
        }

        It "Manifest [ IconUri ] has valid data" {
            $Module.IconUri  | Should -Be 'https://raw.githubusercontent.com/Celerium/Celerium.FanartTV/refs/heads/main/.github/images/PoSHGallery_Celerium.FanartTV.png'
        }

        It "Manifest [ ReleaseNotes ] has valid data" {
            $Module.ReleaseNotes  | Should -Be 'https://github.com/Celerium/Celerium.FanartTV/blob/master/README.md'
        }
