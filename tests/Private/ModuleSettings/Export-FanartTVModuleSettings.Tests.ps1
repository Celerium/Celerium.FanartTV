<#
    ...
    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\ModuleSettings\Export-FanartTVModuleSettings.Tests.ps1

        Runs a pester test and outputs simple results

    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\ModuleSettings\Export-FanartTVModuleSettings.Tests.ps1 -Output Detailed
...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('moduleSettings') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "Should export successfully" {
            ...
            Export-FanartTVModuleSettings -FanartTVConfigPath $exportPath -ErrorVariable moduleSettingsError -WarningAction SilentlyContinue
        ...
        It "Configuration file should contain required values" {
            ...
            $configFile = Import-LocalizedData -BaseDirectory $exportPath -FileName "config.psd1"
                ...
                $configFile.FanartTVModuleBaseUri               | Should -Not -BeNullOrEmpty
                $configFile.FanartTVModulePersonalApiKey        | Should -Not -BeNullOrEmpty
                $configFile.FanartTVModuleProjectApiKey         | Should -Not -BeNullOrEmpty
                $configFile.FanartTVModuleJSONConversionDepth   | Should -Not -BeNullOrEmpty
        }
