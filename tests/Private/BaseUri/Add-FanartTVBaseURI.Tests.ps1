<#
    .SYNOPSIS
        Pester tests for the Celerium.FanartTV baseURI functions
    ...
    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\baseUri\Get-FanartTVBaseURI.Tests.ps1

        Runs a pester test and outputs simple results

    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\baseUri\Get-FanartTVBaseURI.Tests.ps1 -Output Detailed
...
Context "[ $commandName ] testing functions" {
    ...
    It "[ $commandName ] should have an alias of [ Set-FanartTVBaseURI ]" {
        Get-Alias -Name Set-FanartTVBaseURI | Should -BeTrue
    }

    It "Should accept a value from the pipeline" {
        'https://celerium.org' | Add-FanartTVBaseURI
        Get-FanartTVBaseURI | Should -Be 'https://celerium.org/v3.2'
    }

    It "With parameter -BaseUri <value> should return what was inputted" {
        Add-FanartTVBaseURI -BaseUri 'https://celerium.org'
        Get-FanartTVBaseURI | Should -Be 'https://celerium.org/v3.2'
    }
