<#
    ...
    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\baseUri\Remove-FanartTVBaseURI.Tests.ps1

        Runs a pester test and outputs simple results

    .EXAMPLE
        Invoke-Pester -Path .\Tests\Private\baseUri\Remove-FanartTVBaseURI.Tests.ps1 -Output Detailed
...
Describe "Testing [ $commandName ] function with [ $pester_TestName ]" -Tag @('baseUri') {
    ...
    Context "[ $commandName ] testing function" {
        ...
        It "The baseUri variable should not longer exist" {
            ...
            $FanartTVModuleBaseUri | Should -BeNullOrEmpty
        }

        It "If the baseUri is already gone a warning should be thrown" {
            Add-FanartTVBaseURI
            Remove-FanartTVBaseURI
            Remove-FanartTVBaseURI -WarningAction SilentlyContinue -WarningVariable baseUriWarning
